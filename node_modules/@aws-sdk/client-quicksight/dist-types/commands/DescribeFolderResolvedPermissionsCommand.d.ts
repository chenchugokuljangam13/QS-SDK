...
import { DescribeFolderResolvedPermissionsRequest, DescribeFolderResolvedPermissionsResponse } from "../models/models_4";
...
declare const DescribeFolderResolvedPermissionsCommand_base: {
    new (input: DescribeFolderResolvedPermissionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFolderResolvedPermissionsCommandInput, DescribeFolderResolvedPermissionsCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeFolderResolvedPermissionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFolderResolvedPermissionsCommandInput, DescribeFolderResolvedPermissionsCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
