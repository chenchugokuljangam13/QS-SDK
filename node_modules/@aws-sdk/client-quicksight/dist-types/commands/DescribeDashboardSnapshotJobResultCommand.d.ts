...
import { DescribeDashboardSnapshotJobResultRequest, DescribeDashboardSnapshotJobResultResponse } from "../models/models_4";
...
declare const DescribeDashboardSnapshotJobResultCommand_base: {
    new (input: DescribeDashboardSnapshotJobResultCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDashboardSnapshotJobResultCommandInput, DescribeDashboardSnapshotJobResultCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeDashboardSnapshotJobResultCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDashboardSnapshotJobResultCommandInput, DescribeDashboardSnapshotJobResultCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
