...
import { DescribeDataSetRequest, DescribeDataSetResponse } from "../models/models_4";
...
declare const DescribeDataSetCommand_base: {
    new (input: DescribeDataSetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDataSetCommandInput, DescribeDataSetCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeDataSetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDataSetCommandInput, DescribeDataSetCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
