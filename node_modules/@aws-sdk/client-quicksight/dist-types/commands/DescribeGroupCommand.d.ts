...
import { DescribeGroupRequest, DescribeGroupResponse } from "../models/models_4";
...
declare const DescribeGroupCommand_base: {
    new (input: DescribeGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeGroupCommandInput, DescribeGroupCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeGroupCommandInput, DescribeGroupCommandOutput, QuickSightClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
