...
export const se_DescribeKeyRegistrationCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = {};
...
export const se_UpdateKeyRegistrationCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = {
        "content-type": "application/json",
    };
...
export const de_DescribeKeyRegistrationCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
export const de_UpdateKeyRegistrationCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
